...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    //Make sure that in between the two calls to std-cout at the beginning 
    //and at the end of addVehicleToQueue the lock is not held. 
    std::unique_lock<std::mutex> lock1(TrafficObject::_mtxCout);
